...
public class Prueba {
    ...
    public static void main(String[] args) {
        ...
        for (Trabajador t : trabajadores) {
            System.out.println(t);//conversion implicita
            t.cotizar();//metodo polimorfico
        }

        if (c instanceof Camarero) {
            ((Camarero) c).servirMesa("2");//conversion explisita
        }
